...
outputFolderName = ...
    'D:\Nill\code\BART\IED\0_0_new_IED\IED7_Cox_IT_RT_BR_postIED_binary\';
...
function result = runPostIEDCoxAnalysis( ...
    ...
    predictorNames = "any_ied_occurrence_within_" + ...
    ...
    if config.code == "IT"
        primaryInterpretation = ...
            "HR compares any IED occurrence with no IED occurrence; HR > 1 means " + ...
    ...
    fprintf('\n%s effect of any IED occurrence versus none:\n', ...
        codeChar);
    ...
    observedIEDCounts = unique( ...
        countingProcessData.postIED, 'sorted');
...
function plotAdjustedEffectPanel( ...
    ...
    xlabel(ax, ...
        'IED occurrence in any channel (0 = no, 1 = yes)', ...
        'Color', 'k');

    ylabel(ax, ...
        sprintf('relative %s hazard: any IED vs none', ...
            char(config.hazardLabel)), ...
        'Color', 'k');

    title(ax, sprintf('%s: adjusted IED-occurrence effect', char(config.code)), ...
        'Color', 'k', 'FontWeight', 'bold');
