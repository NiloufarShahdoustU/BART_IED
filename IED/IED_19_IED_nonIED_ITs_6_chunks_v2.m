...
% for pt = 1:1
    ...
    for chz = 1:nChans
        ...
        NonIEDTrials_bhvr_measure = NonIEDTrials_bhvr_measure.*(~OutlierIndices); % we are only taking the ITs that are not outliers
        NonIEDTrials_bhvr_measure = NonIEDTrials_bhvr_measure.*ITs;
        ...
        IEDTrials_bhvr_measure = IEDTrials_bhvr_measure.*(~OutlierIndices); % we are only taking the ITs that are not outliers
...
outputFolderName_vecs = '\\155.100.91.44\d\Code\Nill\BART\IED\IED_19_IEDnonIED_bhvr_analysis\v2\ITs\';
