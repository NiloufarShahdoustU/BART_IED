%accuracies
    % we wanna check if IEDs have anything to do with banking balloons!
% Author: Nill
...
outputFolderName = '\\155.100.91.44\d\Code\Nill\BART\IED\IED_19_IEDnonIED_bhvr_analysis\v2\';
outputFolderName_vecs = '\\155.100.91.44\d\Code\Nill\BART\IED\IED_19_IEDnonIED_bhvr_analysis\v2\accuracy\';
...
% for pt = 1:1
    ...
    for chz = 1:nChans
        ...
        %PreOnset1
        NonIEDTrials_bhvr_measure = ~IEDtrialsPreOnset1_only(chz,:); % here RT
        NonIEDTrials_bhvr_measure = NonIEDTrials_bhvr_measure.*(~OutlierIndices); % we are only taking the BankedTrials that are not outliers
        NonIEDTrials_bhvr_measure = NonIEDTrials_bhvr_measure.*BankedTrials;
        NonIEDTrials_bhvr_measure = NonIEDTrials_bhvr_measure(NonIEDTrials_bhvr_measure ~= 0);

        IEDTrials_bhvr_measure = IEDtrialsPreOnset1_only(chz,:); % here RT
        IEDTrials_bhvr_measure = IEDTrials_bhvr_measure.*(~OutlierIndices); % we are only taking the BankedTrials that are not outliers
        IEDTrials_bhvr_measure = IEDTrials_bhvr_measure.*BankedTrials;
        IEDTrials_bhvr_measure = IEDTrials_bhvr_measure(IEDTrials_bhvr_measure ~= 0);
   
        if (size(IEDTrials_bhvr_measure)>0)
            pVal_PreOnset1(chz) = chiSquaredTest(IEDTrials_bhvr_measure,NonIEDTrials_bhvr_measure);
        ...
        clear IEDTrials_bhvr_measure NonIEDTrials_bhvr_measure
         ...
         %PreOnset2
        NonIEDTrials_bhvr_measure = ~IEDtrialsPreOnset2_only(chz,:); % here RT
        NonIEDTrials_bhvr_measure = NonIEDTrials_bhvr_measure.*(~OutlierIndices); % we are only taking the BankedTrials that are not outliers
        NonIEDTrials_bhvr_measure = NonIEDTrials_bhvr_measure.*BankedTrials;
        NonIEDTrials_bhvr_measure = NonIEDTrials_bhvr_measure(NonIEDTrials_bhvr_measure ~= 0);

        IEDTrials_bhvr_measure = IEDtrialsPreOnset2_only(chz,:); % here RT
        IEDTrials_bhvr_measure = IEDTrials_bhvr_measure.*(~OutlierIndices); % we are only taking the BankedTrials that are not outliers
        IEDTrials_bhvr_measure = IEDTrials_bhvr_measure.*BankedTrials;
        IEDTrials_bhvr_measure = IEDTrials_bhvr_measure(IEDTrials_bhvr_measure ~= 0);
   
        if (size(IEDTrials_bhvr_measure)>0)
            pVal_PreOnset2(chz) = chiSquaredTest(IEDTrials_bhvr_measure,NonIEDTrials_bhvr_measure);
        ...
        %PostOnset
        NonIEDTrials_bhvr_measure = ~IEDtrialsPostOnset_only(chz,:); % here RT
        NonIEDTrials_bhvr_measure = NonIEDTrials_bhvr_measure.*(~OutlierIndices); % we are only taking the BankedTrials that are not outliers
        NonIEDTrials_bhvr_measure = NonIEDTrials_bhvr_measure.*BankedTrials;
        NonIEDTrials_bhvr_measure = NonIEDTrials_bhvr_measure(NonIEDTrials_bhvr_measure ~= 0);

        IEDTrials_bhvr_measure = IEDtrialsPostOnset_only(chz,:); % here RT
        IEDTrials_bhvr_measure = IEDTrials_bhvr_measure.*(~OutlierIndices); % we are only taking the BankedTrials that are not outliers
        IEDTrials_bhvr_measure = IEDTrials_bhvr_measure.*BankedTrials;
        IEDTrials_bhvr_measure = IEDTrials_bhvr_measure(IEDTrials_bhvr_measure ~= 0);
   
        if (size(IEDTrials_bhvr_measure)>0)
            pVal_PostOnset(chz) = chiSquaredTest(IEDTrials_bhvr_measure,NonIEDTrials_bhvr_measure);
        ...
        %PreResponse
        NonIEDTrials_bhvr_measure = ~IEDtrialsPreResponse_only(chz,:); % here RT
        NonIEDTrials_bhvr_measure = NonIEDTrials_bhvr_measure.*(~OutlierIndices); % we are only taking the BankedTrials that are not outliers
        NonIEDTrials_bhvr_measure = NonIEDTrials_bhvr_measure.*BankedTrials;
        NonIEDTrials_bhvr_measure = NonIEDTrials_bhvr_measure(NonIEDTrials_bhvr_measure ~= 0);

        IEDTrials_bhvr_measure = IEDtrialsPreResponse_only(chz,:); % here RT
        IEDTrials_bhvr_measure = IEDTrials_bhvr_measure.*(~OutlierIndices); % we are only taking the BankedTrials that are not outliers
        IEDTrials_bhvr_measure = IEDTrials_bhvr_measure.*BankedTrials;
        IEDTrials_bhvr_measure = IEDTrials_bhvr_measure(IEDTrials_bhvr_measure ~= 0);
   
        if (size(IEDTrials_bhvr_measure)>0)
            pVal_PreResponse(chz) = chiSquaredTest(IEDTrials_bhvr_measure,NonIEDTrials_bhvr_measure);
        ...
        clear IEDTrials_bhvr_measure NonIEDTrials_bhvr_measure
         ...
         %PostResponse
        NonIEDTrials_bhvr_measure = ~IEDtrialsPostResponse_only(chz,:); % here RT
        NonIEDTrials_bhvr_measure = NonIEDTrials_bhvr_measure.*(~OutlierIndices); % we are only taking the BankedTrials that are not outliers
        NonIEDTrials_bhvr_measure = NonIEDTrials_bhvr_measure.*BankedTrials;
        NonIEDTrials_bhvr_measure = NonIEDTrials_bhvr_measure(NonIEDTrials_bhvr_measure ~= 0);

        IEDTrials_bhvr_measure = IEDtrialsPostResponse_only(chz,:); % here RT
        IEDTrials_bhvr_measure = IEDTrials_bhvr_measure.*(~OutlierIndices); % we are only taking the BankedTrials that are not outliers
        IEDTrials_bhvr_measure = IEDTrials_bhvr_measure.*BankedTrials;
        IEDTrials_bhvr_measure = IEDTrials_bhvr_measure(IEDTrials_bhvr_measure ~= 0);
   
        if (size(IEDTrials_bhvr_measure)>0)
            pVal_PostResponse(chz) = chiSquaredTest(IEDTrials_bhvr_measure,NonIEDTrials_bhvr_measure);
        ...
        clear IEDTrials_bhvr_measure NonIEDTrials_bhvr_measure
         ...
         %PreOutcome
        NonIEDTrials_bhvr_measure = ~IEDtrialsPreOutcome_only(chz,:); % here RT
        NonIEDTrials_bhvr_measure = NonIEDTrials_bhvr_measure.*(~OutlierIndices); % we are only taking the BankedTrials that are not outliers
        NonIEDTrials_bhvr_measure = NonIEDTrials_bhvr_measure.*BankedTrials;
        NonIEDTrials_bhvr_measure = NonIEDTrials_bhvr_measure(NonIEDTrials_bhvr_measure ~= 0);

        IEDTrials_bhvr_measure = IEDtrialsPreOutcome_only(chz,:); % here RT
        IEDTrials_bhvr_measure = IEDTrials_bhvr_measure.*(~OutlierIndices); % we are only taking the BankedTrials that are not outliers
        IEDTrials_bhvr_measure = IEDTrials_bhvr_measure.*BankedTrials;
        IEDTrials_bhvr_measure = IEDTrials_bhvr_measure(IEDTrials_bhvr_measure ~= 0);
   
        if (size(IEDTrials_bhvr_measure)>0)
            pVal_PreOutcome(chz) = chiSquaredTest(IEDTrials_bhvr_measure,NonIEDTrials_bhvr_measure);
...
xlabel('non-IED trials vs IED trials', 'FontSize', 14, 'FontWeight', 'bold');
% ylim([0 5]);
ylabel('mean acc', 'FontSize', 14, 'FontWeight', 'bold');
set(gca, 'FontSize', 12, 'FontWeight', 'bold');
...
filePath = fullfile(outputFolderName, 'acc_stat.txt');
