...
inputFolderName_IEDtrials = '\\155.100.91.44\d\Data\Nill\BART\bad_chans_removed_IEDdata_LFPmat_6_chunks_v2';
fileList = dir(fullfile(inputFolderName_IEDtrials, '*.LFPIED.mat'));
outputFolderName = '\\155.100.91.44\d\Code\Nill\BART\IED\IED_0_outputs\v3\';
