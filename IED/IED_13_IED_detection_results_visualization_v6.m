...
% for pt = 1:2
    ...
    if(~isempty(IEDChanTrial_indices))
       ...
       % save
        outputFolderName = '\\155.100.91.44\d\Code\Nill\BART\IED\IED_13_sanity_check_v6\preOnset1\';
    ...
    if(~isempty(IEDChanTrial_indices))
       ...
       % save
        outputFolderName = '\\155.100.91.44\d\Code\Nill\BART\IED\IED_13_sanity_check_v6\PreOnset2\';
        set(gcf, 'Units', 'inches');
        screenposition = get(gcf, 'Position');
        set(gcf, 'PaperPosition', [0 0 screenposition(3:4)], 'PaperSize', [screenposition(3:4)]);
        filename = string(ptID) + '_IED_detection_sanity_check';
    ...
    if(~isempty(IEDChanTrial_indices))
       ...
       % save
        outputFolderName = '\\155.100.91.44\d\Code\Nill\BART\IED\IED_13_sanity_check_v6\PostOnset\';
        set(gcf, 'Units', 'inches');
        screenposition = get(gcf, 'Position');
        set(gcf, 'PaperPosition', [0 0 screenposition(3:4)], 'PaperSize', [screenposition(3:4)]);
        filename = string(ptID) + '_IED_detection_sanity_check';
    ...
    if(~isempty(IEDChanTrial_indices))
       ...
       % save
        outputFolderName = '\\155.100.91.44\d\Code\Nill\BART\IED\IED_13_sanity_check_v6\PreResponse\';
        set(gcf, 'Units', 'inches');
        screenposition = get(gcf, 'Position');
        set(gcf, 'PaperPosition', [0 0 screenposition(3:4)], 'PaperSize', [screenposition(3:4)]);
        filename = string(ptID) + '_IED_detection_sanity_check';
 ...
 %% PostResponse
    ...
    if(~isempty(IEDChanTrial_indices))
       ...
       % save
        outputFolderName = '\\155.100.91.44\d\Code\Nill\BART\IED\IED_13_sanity_check_v6\PostResponse\';
        set(gcf, 'Units', 'inches');
        screenposition = get(gcf, 'Position');
        set(gcf, 'PaperPosition', [0 0 screenposition(3:4)], 'PaperSize', [screenposition(3:4)]);
        filename = string(ptID) + '_IED_detection_sanity_check';
    ...
    if(~isempty(IEDChanTrial_indices))
       ...
       % save
        outputFolderName = '\\155.100.91.44\d\Code\Nill\BART\IED\IED_13_sanity_check_v6\PreOutcome\';
        set(gcf, 'Units', 'inches');
        screenposition = get(gcf, 'Position');
        set(gcf, 'PaperPosition', [0 0 screenposition(3:4)], 'PaperSize', [screenposition(3:4)]);
        filename = string(ptID) + '_IED_detection_sanity_check';
