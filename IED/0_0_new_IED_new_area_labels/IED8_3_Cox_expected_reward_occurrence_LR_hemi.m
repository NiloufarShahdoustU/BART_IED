...
function plotHemisphereExpectedRewardForest(ax, result, config, ...
    ...
    hazardRatioValues = [ ...
        plotData.hazardRatio_IED(1); ...
        plotData.hazardRatio_IED(2); ...
        plotData.hazardRatio_IEDxExpectedReward(1); ...
        plotData.hazardRatio_IEDxExpectedReward(2)];

    lowValues = [ ...
        plotData.hazardRatioCILow_IED(1); ...
        plotData.hazardRatioCILow_IED(2); ...
        plotData.hazardRatioCILow_IEDxExpectedReward(1); ...
        plotData.hazardRatioCILow_IEDxExpectedReward(2)];

    highValues = [ ...
        plotData.hazardRatioCIHigh_IED(1); ...
        plotData.hazardRatioCIHigh_IED(2); ...
        plotData.hazardRatioCIHigh_IEDxExpectedReward(1); ...
        plotData.hazardRatioCIHigh_IEDxExpectedReward(2)];
    ...
    resultText = sprintf([ ...
        ...
        exp(contrast.betaLeftMinusRight_IEDxExpectedReward), ...
...
function plotHemisphereExpectedRewardCurves(ax, result, config, ...
    ...
    resultText = sprintf([ ...
        'HR per reward unit outside = %.3f\n' ...
        'HR per reward unit after left IED = %.3f\n' ...
        'HR per reward unit after right IED = %.3f\n' ...
        'L-R interaction p = %.3g'], ...
        exp(result.expectedRewardSlopeOutsideIED), ...
        exp(result.expectedRewardSlopeLeftIED), ...
        exp(result.expectedRewardSlopeRightIED), ...
        contrast.clusterRobustPValue_IEDxExpectedReward);
