...
function plotHemisphereNivForest(ax, result, config, ...
    ...
    betaValues = [ ...
        plotData.beta_IED(1); plotData.beta_IED(2); ...
        plotData.beta_IEDxNiv(1); plotData.beta_IEDxNiv(2)];
    lowValues = [ ...
        plotData.betaCILow_IED(1); plotData.betaCILow_IED(2); ...
        plotData.betaCILow_IEDxNiv(1); ...
        plotData.betaCILow_IEDxNiv(2)];
    highValues = [ ...
        plotData.betaCIHigh_IED(1); plotData.betaCIHigh_IED(2); ...
        plotData.betaCIHigh_IEDxNiv(1); ...
        plotData.betaCIHigh_IEDxNiv(2)];
    permutationPValues = [ ...
    ...
    title(ax, sprintf('%s: left/right Niv moderation', config.code), ...
        'FontWeight', 'bold');

    resultText = sprintf([ ...
        'Interaction difference (L - R) = %.3f\n' ...
        'robust p = %.3g\noutcome-shuffle p = %.3g'], ...
        contrast.betaLeftMinusRight_IEDxNiv, ...
...
function plotHemisphereNivCurves(ax, result, config, ...
    ...
    ylabel(ax, sprintf('HR for %s after IED vs outside window', ...
        config.hazardName));
    title(ax, sprintf('%s: IED effect across Niv asymmetry', ...
        config.code), 'FontWeight', 'bold');

    resultText = sprintf([ ...
        'Left IED x Niv beta = %.3f, p_{perm} = %.3g\n' ...
        'Right IED x Niv beta = %.3f, p_{perm} = %.3g\n' ...
        'L-R interaction p = %.3g'], ...
        result.hemisphereResults.beta_IEDxNiv(1), ...
        result.hemisphereResults.permutationPValue_IEDxNiv(1), ...
        result.hemisphereResults.beta_IEDxNiv(2), ...
