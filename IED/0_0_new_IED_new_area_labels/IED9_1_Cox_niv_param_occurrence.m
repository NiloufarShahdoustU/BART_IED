% Cox models for IED occurrence x Niv learning asymmetry
...
outputFolder = ...
    'D:\Nill\code\BART\IED\0_0_new_IED_new_area_labels\IED9_1_Cox_niv_param_occurrence\';
...
combinedFigureOutputFile = fullfile(outputFolder, ...
    'IT_RT_BR_PR_whole_IED_x_Niv_4x2.pdf');
...
function plotNivCurve(ax, result, config, iedMode)
    ...
    resultText = sprintf([ ...
        'IED x Niv HR multiplier = %.3f\n' ...
        '95%% CI [%.3f, %.3f]\n' ...
        'permutation p = %.3g'], ...
        interaction.hazardRatio, ...
