% In this version there are some channels that are not real channels and
% they seem like to be noisy channels! I am writing another code, which is
% version 2 of IED__IEd_nonIED_saving_IED_and_LFP

% in this code I am going to take a look at the IED detections. We plan to
% pass these out to surgeons so that they can tell if our IED detection
% works properly.
...
inputFolderName_IEDdata = '\\155.100.91.44\d\Data\Nill\BART\IEDdata';
inputFolderName_LFPmat = '\\155.100.91.44\d\Data\Nill\BART\LFPmat';
outputFolderName = '\\155.100.91.44\d\Code\Nill\BART\IED\IED_13_sanity_check_v1\';
