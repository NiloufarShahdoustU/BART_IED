% ccn 2026
% RT: power box plot (BOXPLOT + SCATTER per trial, band 8-80 Hz)
...
outputFolderName = '\\155.100.91.44\d\Code\Nill\BART\IED\IED_26_IED_non_IED_power_boxplot_v1_RT\';
...
% for pt = 1:1
    ...
    sgtitle(sprintf('%s | RT Band power boxplots', ptID), 'Interpreter','none');

    fnameBase = sprintf('%s_RT_BoxplotBandPower_%dto%dHz_2epochs_ALLareas_yTop%d_stats', ...
