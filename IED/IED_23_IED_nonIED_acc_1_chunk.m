...
outputFolderName = 'D:\Nill\code\BART\IED\IED_23_IED_nonIED_acc_1_chunk\';
...
name = 'IEDtrials_bhvr_measure_mean_acc_PostResponse';
...
% who also have valid Post-Response IED accuracy points
% =========================
...
filename = 'acc_boxplot_PostResponse';
saveas(gcf, fullfile(outputFolderName, filename), 'pdf');

pValuePostResponse_acc_pt = ranksum(vec1,vec2);

outputFileName = fullfile(outputFolderName, 'acc_pValues_PostResponse.txt');
