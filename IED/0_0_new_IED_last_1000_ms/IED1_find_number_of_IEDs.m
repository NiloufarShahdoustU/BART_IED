% Find IEDs from RT - 1000 ms to RT and from IT - 1000 ms to IT
...
figureOutputFolder = ...
    'D:\Nill\code\BART\IED\0_0_new_IED_last_1000_ms\IED1_find_number_of_IEDs\';
...
for pt = 1:length(fileList)
    ...
    % Keep RT - 1000 ms to RT and IT - 1000 ms to IT
    ...
    for trial = 1:nTrials
        ...
        % If the interval is shorter than 1000 ms, use its whole duration
    ...
    % Column 1 = trial
    % Column 2 = channel
    % Column 3 = time index inside the 1000 ms window
    ...
    % The plotting window is independent of the saved 1000 ms RT and IT data.
