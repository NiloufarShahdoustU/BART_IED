...
try
    ...
    % addpath('/matlab/bartc/') % [20170711::EHS] This part is weird and
    % reduntant as far as I can tell
    ...
    addDigitalChannel(dio,'Dev1','Port0/Line8:15','OutputOnly')
    sbit = false;
    outputSingleScan(dio,[decimalToBinaryVector(0,7,'lsbfirst'),sbit])
    ...
    while continue_running
        ...
        mark_event('trial_start',trial_type+(10*is_control));
        ...
        while keep_waiting
            ...
            if (GetSecs-trial_start_time)>max_rt
                ...
                disp(line);
                result = 'no response';
                mark_event('max rt exceeded',255)
